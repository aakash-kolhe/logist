...
?>
        ...
        <!-- ============================================================== -->
        <div class="content-wrapper" style="width: 100%; margin: 142px 0px 0px 0px;">
            <section id="rotate" class="" style="width: 100%; transform: rotate(90deg)">
            <!-- <section id="rotate" class="mx-5" style="transform: rotate(90deg)"> -->
                <div class="container-fluid" style="width: 125%;">
                    <div class="row ml-2 text-danger" style="width: 100%">
                        ...
                        <div class="col-md-4"  style="text-align: center;">
                            <h5 class="m-0 pt-4"><b class="text-danger">Subjected To <?= $ConsignmentDetailsRes['jurisdiction']?></b></h5>
                        </div>
                        <div class="col-md-4" style="text-align: right; padding-right: 4rem!important;">
                ...
                <div class="row ml-2 text-danger" style="width: 129%">
                ...
                <div class="row" style="width: 125%;">
                    <div class="col-md-9">
                        ...
                        <div class="row ml-2"  style="">
                            <div class="col-md-4">
                                <div style="padding: 0px 10px 0px 10px; border: 1px solid; border-radius: 18px; margin-bottom: 10px; line-height: 15px; font-size: 14px;">
                                    <h6 class="m-0 p-0 text-bold">SCHEDULE OF DEMURRAGE CHARGES</h6>
                                    <p class="m-0 p-0"><b>Demurrage Chargable after</b>&nbsp;<?= $ConsignmentDetailsRes['demurrage_validity']?><br>
                                        <b>days from to day Rs</b>&nbsp;&nbsp;&nbsp;<?= $ConsignmentDetailsRes['charges']?>&nbsp;&nbsp;&nbsp;<b>per</b>
                                        <b>day per Qtl on weight charges.</b>
                                    </p>
                                </div>
                                <div class="text-danger" style="padding: 12px;border: 1px solid black; border-top-right-radius: 25px; border-top-left-radius: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px;">
                                    <h5 class="m-0 p-0 text-center"><b>NOTICE</b></h5>
                                    <p class="m-0 p-0 text-jusify" style="font-size: 14px; text-align: justify; line-height: 16px;">The consignment covered by the set of special Long Receipt form bestored at the destination under the control of the transport Operator and shall be delivered to or to the order of the consignee Bank whose name is mentioned in the Lory Receipt it will under no circumstances be delivered to anyone without the written authority from the Consignee Bank or its order, endorsed on the consignee copy or on a separate Letter or Authority</p>
                                </div>  
                            </div>
                            <div class="col-md-4">
                                <div style="padding: 0px 10px 0px 10px; border: 1px solid; border-radius: 18px; margin-bottom: 10px;">
                                    <h6 class="p-0 text-bold text-center text-danger"style="margin-top: -2px;">CONSIGNEE COPY</h6><hr class="m-0 p-0">
                                    <h6 class="m-0 p-0 text-center">AT OWNER RISK</h6>
                                    <h6 class="m-0 p-0 text-center">TRANSIST DELIVERY INSTRUCTION</h6>
                                </div>
                                <div style="width: 100%;height: 200px; border: 1px solid; border-top-right-radius: 25px; border-top-left-radius: 25px; border-bottom-right-radius: 25px; border-bottom-left-radius: 25px;">
                                    <p class="m-0 pl-3">The Customer has stated that:</p>
                                    <div class="row">
                                        <div class="col-md-12 pl-3">
                                            ...
                                            <b>Policy No.:</b><span><?= $ConsignmentDetailsRes['policyNumber']?></span><br>
                            ...
                            <div class="col-md-4">
                                <div style="padding: 0px 10px 0px 10px; border: 1px solid; border-radius: 18px; margin-bottom: 10px;">
                                    <h6 class="text-bold text-center">BRANCH CODE</h6>
                                    <p class="text-center" style="margin-bottom: 13px;"><?= $ConsignmentDetailsRes['branch_name']?></p>
                                </div>
                                <div style="padding: 0px 10px 0px 10px; border: 1px solid; border-radius: 18px; margin-bottom: 10px;">
                                    <h6 class="text-danger text-bold text-center m-0 p-0">CAUTION</h6>
                                    <p class="text-danger" style="margin-bottom: 13px; line-height: 16px; font-size: 14px;">This consignment will not be detained diverted re round or re-booked without Consignee bank's written permission will be delivered at the destination</p>
                                </div>
                                <p class="m-0 p-0">FROM</p>
                                <div style="padding: 0px 10px 0px 10px; border: 1px solid; border-radius: 18px; margin-bottom: 10px;">
                                    <h6 class="text-bold text-center"><?= strtoupper($ConsignmentDetailsRes['from_Location'])?></h6>
                                </div>
                                <p class="m-0 p-0">TO</p>
                                <div style="padding: 0px 10px 0px 10px; border: 1px solid; border-radius: 18px; margin-bottom: 10px;">
                                    <h6 class="text-bold text-center"><?= strtoupper($ConsignmentDetailsRes['to_Location'])?></h6>
                                </div>
                            </div>
                        </div>
                        <div class="row ml-2"  style="padding: 0px 8px;">
                            <div class="col-md-12" style="border: 1px solid; border-radius: 18px;">
                          ...
                          <tr>
                            ...
                            <td rowspan="5">
                                <?php
                                    ...
                                    ?><br>&nbsp;
                                    <?php
                                        echo '<b>'.($grandValue = $value + $totalGst).'</b>';
                                    ?><br>
                            </td>
                          </tr>
                          <tr>
                    ...
                    <div class="col-md-3" style="border: 1px solid; border-radius: 18px;">
                        <p style="font-size: 18px; text-align: left;"><b>Consignment Note</b></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><?= $ConsignmentDetailsRes['consignment_no']?></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><b>Date: </b><?= date("d-m-Y",strtotime($ConsignmentDetailsRes['created'])) ?></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><b>LORRY NO.</b></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><?= $ConsignmentDetailsRes['vehicle_number']?></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><b>Classification Goods</b></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><?= $ConsignmentDetailsRes['goods_classification']?></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><b>GST PAID BY</b></p><hr style="border-top: 1px solid rgb(0 0 0);">
                        <p style="font-size: 18px; text-align: left;"><?= $ConsignmentDetailsRes['GST_Paidby']?></p><hr style="border-top: 1px solid rgb(0 0 0);">
                    </div>
                    <div class="ml-2 col-md-12" style="">
                        <p class="text-right text-danger"><b>FOR:</b><?= strtoupper($ConsignmentDetailsRes['company_name'])?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</p>
