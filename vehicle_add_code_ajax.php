<?php
    ...
    if(isset($_POST['checking_add_vehicle']))
    {
      ...
      $vehicle_master = "INSERT INTO vehicle_mstr SET vehicle_no = '$vehicle_no', company_Id = '$company_Id', vehicle_Name = '$vehicle_Name', make = '$make', model = '$model', contact_Id = '$contact_Id', chassis_No = '$chassis_No', engine_No = '$engine_No', certificate = '$certificate', expiry_date = '$expiry_date'";
    // echo $vehicle_master;exit;
